$(function () {
  $('#registerCustomer').on('click', function(e){
    ...
    const data = {
      ui_business_name : ui_business_name,
      ui_proprietor_name : ui_proprietor_name,
      ui_mobile : ui_mobile,
      ui_email : ui_email,
      ui_omc : ui_omc,
      ui_latitude : ui_latitude,
      ui_longitude : ui_longitude,
      ...
      ui_demand : ui_demand,
      ui_demand_type : ui_demand_type,
      ui_current_package : ui_current_package,
      ui_current_pkg_type : ui_current_pkg_type,
      ui_discount : ui_discount,
    };
    $.ajax({
      type: 'POST',
